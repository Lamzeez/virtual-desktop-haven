...
import XmlTransformerAppContent from '@/components/apps/XmlTransformerApp';

const XmlTransformerAppPage = () => {
  return (
    <div className="min-h-screen bg-desktop-bg flex flex-col">
      <header className="bg-desktop-window p-4 border-b border-white/10 flex items-center">
        ...
        <h1 className="text-2xl font-bold text-white ml-4">XML Transformer</h1>
      </header>
      
      <main className="flex-1 p-4 overflow-auto">
        <div className="bg-desktop-window rounded-lg p-4 border border-white/10 h-full">
          <XmlTransformerAppContent />
        </div>
      </main>
    </div>
  );
...
export default XmlTransformerAppPage;
